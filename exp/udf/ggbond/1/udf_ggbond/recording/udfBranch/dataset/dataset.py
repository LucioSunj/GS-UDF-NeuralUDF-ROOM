...
class Dataset:
    ...
    def gen_random_rays_patches_at_return_pixels(self, img_idx, batch_size, importance_sample=False, h_patch_size=3,
                                   crop_patch=False):
        """
        Generate random rays in world space from a specified camera.
    ...
    def near_far_from_sphere(self, rays_o, rays_d):
        ...
        这个函数通过解射线方程来确定射线与单位球体的交点。
        射线方程的形式是 r(t) = o + td，其中 o 是射线的起点，d 是射线的方向，
        t 是一个参数，表示从起点到交点的距离。单位球体的方程是 ||r(t)||^2 = 1。
