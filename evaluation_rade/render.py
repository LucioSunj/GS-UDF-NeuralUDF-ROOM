...
import torch
from gsBranch.scene import Scene
import os
from tqdm import tqdm
from os import makedirs
from gsBranch.gaussian_renderer import render_rade
import torchvision
from gsBranch.utils.general_utils import safe_state
from argparse import ArgumentParser
from gsBranch.arguments import ModelParams, PipelineParams, get_combined_args
from gsBranch.gaussian_renderer import GaussianModel
...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, kernel_size):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        rendering = render_rade(view, gaussians, pipeline, background, kernel_size=kernel_size)["render"]
